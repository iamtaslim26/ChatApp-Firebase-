...
public class SettingsActivity extends AppCompatActivity
{
    ...
    {
        UpdateAccountSettings = (Button) findViewById(R.id.set_update);
        userName = (EditText) findViewById(R.id.set_user_name);
        userStatus = (EditText) findViewById(R.id.set_status);
        imageview = (CircleImageView) findViewById(R.id.set_profile_image);
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            databaserefference.child("Users").child(currentUserID).child("image")
    ...
    private void UpdateSettings()
    {
        ...
        else
        {
            ...
            profileMap.put("name", muser);
            profileMap.put("status", mstatus);
            databaserefference.child("Users").child(currentUserID).updateChildren(profileMap)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task)
                        {
    ...
    {
        databaserefference.child("Users").child(currentUserID)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        if ((dataSnapshot.exists()) && (dataSnapshot.hasChild("name") && (dataSnapshot.hasChild("image"))))
                        {
                            ...
                            Picasso.get().load(retrieveProfileImage).placeholder(R.drawable.profile_image).into(imageview);
                        }
